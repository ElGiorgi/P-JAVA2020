...
public class AddressTest {
	...
	public void testSetNumber() {
		this.addressTest2.setNumber("00");
		assertEquals(this.addressTest2.getNumber(), "00");
	}
	...
	public void testSetLocation() {
		this.addressTest2.setLocation("location");
		assertEquals(this.addressTest2.getLocation(), "location");	
	}
	...
	public void testSetNumberNotValid() {
		try {
			this.addressTest2.setNumber("no valido");
			fail("No debe llegar aquí...");
		} 
		catch (ModelsException e) { 
		}
	...
	public void testSetPostalCodeNotValid() {
		try {
			this.addressTest2.setPostalCode("no valido");
			fail("No debe llegar aquí...");
		} 
		catch (ModelsException e) { 
		}
	...
	public void testSetLocationNotValid() {
		try {
			this.addressTest2.setPostalCode("N0 V4lido");
			fail("No debe llegar aquí");
		} 
		catch (ModelsException e) { 
		}
